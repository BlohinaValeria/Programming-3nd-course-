...
## Задание. Разместите представленный ниже код локально на компьютере и реализуйте механизм удаленного импорта. Продемонстрируйте в виде скринкаста или в текстовом отчете с несколькими скриншотами работу удаленного импорта.
...
## Ссылка на  Replit:
[перейти](https://replit.com/@letablohina2017/LR1?v=1)
...
## Структура файлов
![](https://github.com/BlohinaValeria/Programming-3nd-course-/blob/main/1nd-semester/LR1/структура.png)

## Импорт пакетов
![](https://github.com/BlohinaValeria/Programming-3nd-course-/blob/main/1nd-semester/LR1/импорт%20пакетов.png)
