...
сервер возвращает HTTP 400 в ответе JSON с сообщением об ошибке
...
Тест защиты от отрицательных значений при попытке уменьшить счётчик ниже 0 сервер возвращает ошибку
